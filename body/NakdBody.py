...
rfile = open("/Users/MWK/Desktop/nkd/body/NakdBody.html","r")
rpdb = rfile.read()
rfile.close()
...
contents = repo.get_contents("bodys.json")
repo.update_file(contents.path, "updated bodys.json from python3", json.dumps(json.loads(final), indent=4), contents.sha, branch="master")
