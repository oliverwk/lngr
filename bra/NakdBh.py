...
rfile = open("/Users/MWK/Desktop/nkd/bra/NakdBh.html","r")
rpdb = rfile.read()
rfile.close()
...
contents = repo.get_contents("bras.json")
repo.update_file(contents.path, "updated bpras.json from python3", json.dumps(json.loads(final), indent=4), contents.sha, branch="master")
