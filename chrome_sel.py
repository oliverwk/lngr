...
browser = webdriver.Chrome('/Users/MWK/Desktop/OLE/chromedriver', options=chrome_options);
print("Launched")
browser.get("https://www.na-kd.com/nl/lingerie/onderbroeken?sortBy=price&count=18&p_categories=c_1-32927_nl-nl")
time.sleep(4)
print("Arrived")
